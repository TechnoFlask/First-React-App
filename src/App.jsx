  ...
  return (
    <>
      ...
      <Router>
        ...
        <Routes>
          <Route exact path="/First-React-App/textarea" element={<Textarea heading='Enter your text' rows={8} default='Enter your text here' mode={mode} />} />
          <Route exact path="/First-React-App/about" element={<About toggleMode={toggleMode} mode={mode} color={color} />} />
        </Routes>
      </Router>
